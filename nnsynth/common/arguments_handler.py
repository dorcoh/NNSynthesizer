...
class ArgumentsParser:
    ...
    # xor dataset args
    parser.add_argument('-d', '--dataset_size', default=50, type=int,
                        help='Number of instances for data generation per centroid')
    parser.add_argument('-s', '--std', default=2.5, type=int,
    ...
    parser.add_argument('-pd', '--pr_delta', default=8, type=float,
