...
from nnsynth.neural_net import get_predicted_tuple, get_predicted_score_tuple
        ...
        if eval_set is not None:
            if eval_set_type == 'predicted':
                ...
                if limit_num_samples:
                    ...
                    ret_eval_set = func()
            elif eval_set_type == 'predicted_score':
                if limit_num_samples:
                    X = eval_set_mapping[eval_set][1](limit_num_samples)[0]
                else:
                    X = eval_set_mapping[eval_set][0]
                ret_eval_set = get_predicted_score_tuple(net, X)
